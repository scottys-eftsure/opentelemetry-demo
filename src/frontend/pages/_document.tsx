...
const { ENV_PLATFORM, WEB_OTEL_SERVICE_NAME, PUBLIC_OTEL_EXPORTER_OTLP_TRACES_ENDPOINT, OTEL_COLLECTOR_HOST, FARO_COLLECTOR_URL, FARO_APP_NAME} = process.env;
    ...
    try {
      ...
      const envString = `
        window.ENV = {
          ...
          NEXT_PUBLIC_FARO_URL: '${FARO_COLLECTOR_URL ?? ''}',
